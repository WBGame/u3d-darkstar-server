...
ManagedObject {
	...
	/**
	 * El nombre del channel <i>broadcasteador</i>. Ver los links en 
	 * "See Also" para entender donde se crean los channels y donde se 
	 ...
	 * @author Sebastián Perruolo
	 */
	public static final String CHANNEL_CLIENTS = "clients";
	...
	public final void initialize(final Properties props) {
		...
		channelMgr.createChannel(CHANNEL_3_NAME, 
				new ServerChannelsBroadcastListener(//comportamiento 
						CHANNEL_2_NAME				//de broadcasting
				),			
				Delivery.RELIABLE);
