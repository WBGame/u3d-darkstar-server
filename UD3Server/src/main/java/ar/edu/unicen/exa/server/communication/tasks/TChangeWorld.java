 ...
 * el cual informa que cambiará al mundo indicado en el mensaje. Las acciones
...
public final class TChangeWorld extends TaskCommunication {
	...
	public void run() {
		...
		try {
			msgLeft = MessageFactory.getInstance()
					.createMessage(MsgTypes.MSG_LEFT_TYPE);
		...
		ServerMsgProcessor processor = 
				...
				.createProcessor(MsgTypes.MSG_ENTER_WORLD_TYPE);
